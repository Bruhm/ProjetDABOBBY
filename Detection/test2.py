...
def surf(img1):
        list1 = ["1.png","2.png","3.png","4.png","5.png","6.png","7.png","8.png"]
        count = 0;
        count2 = 0;
        xgeneral = 0
        ygeneral =0
        for s in list1:
                ...
                opencv_needle =cv2.imread(list1[count2])
                ...
                cv2.circle(opencv_haystack,center,20,(255,0,0),-1)
                #cv2.imshow('haystack',opencv_haystack)
                #cv2.imshow('needle',opencv_needle)
                #cv2.waitKey(0)
                #cv2.destroyAllWindows()
        print str(list1[count2] + img1)
        if responses > count:
                xgeneral = x
                ygeneral = y
                count2 = count2+1
